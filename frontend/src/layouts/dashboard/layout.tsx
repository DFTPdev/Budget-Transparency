...
export function DashboardLayout({
  ...
  // Fixed to vertical layout since we removed settings
  const navLayout = 'vertical';
  const navColor = 'integrate';
  ...
  const renderSidebar = () => (
    <NavVertical
      ...
      checkPermissions={canDisplayItemByRole}
      onToggleNav={() => {
        // Navigation toggle disabled since we removed settings
      }}
    />
  );
